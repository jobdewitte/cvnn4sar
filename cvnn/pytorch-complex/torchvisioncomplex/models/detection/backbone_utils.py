...
from torchvisioncomplex.ops.feature_pyramid_network import ExtraFPNBlock, FeaturePyramidNetwork, LastLevelMaxPool
...
class BackboneWithFPN(cxnn.Module):
    """
...
def resnet_fpn_backbone(
    *,
    ...
    norm_layer: Callable[..., cxnn.Module] = cxnn.BatchNorm2d, # misc_nn_ops.FrozenBatchNorm2d,
    ...
    Args:
        backbone_name (string): resnet architecture. Possible values are 'resnet18',, 'resnet50',
