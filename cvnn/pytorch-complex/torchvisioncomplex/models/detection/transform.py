...
class GeneralizedRCNNTransform(cxnn.Module):
    """
    ...
    def __init__(
        ...
        min_size: int,
        max_size: int,
        image_mean: List[complex],
        image_std: List[complex],
    ...
    def normalize(self, image: Tensor) -> Tensor:
        if not image.is_complex():
            raise TypeError(
                f"Expected input images to be of complex type, "
